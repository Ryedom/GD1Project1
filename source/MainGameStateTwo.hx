...
class MainGameStateTwo extends TransitionSetup
{
	private var _map : GameMap;
	private var _mapPath : String = AssetPaths.levelTwo__oel;
	private var _background : FlxSprite;
	private var _pipeAmounts : Array<Int> = [6,3,0,1];
	private var _timerText: FlxText;
	private var _timer: Float = 75;
	...
	override public function update(elapsed:Float) : Void {
		...
		if (!_map.winCondition){
			...
			if(FlxG.keys.pressed.ANY)
				FlxG.switchState(new SceneBetweenTwo());
		}
	}
