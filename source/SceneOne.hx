...
class SceneOne extends FlxState
{
	...
	override public function create():Void
	{
		...
		_char[0].setImage("assets/images/CutsceneAssets/kitchen_fridge.png", 1280, 720);
		_char[0].setPosition(0, 0);
		_char[0].changeFloorHeight(0);
		
		_char[1] = new EventImage();
		_char[1].setImage("assets/images/CutsceneAssets/kitchen_mom.png", 1280, 720);
		_char[1].setPosition(0, 0);
		_char[1].changeFloorHeight(0);
		
		_char[2] = new EventImage();
		_char[2].setImage("assets/images/CutsceneAssets/kitchen_bang.png", 1280, 720);
		_char[2].setPosition(0, 0);
		_char[2].changeFloorHeight(0);
		
		_char[3] = new EventImage();
		_char[3].setImage("assets/images/CutsceneAssets/kitchen_son.png", 1280, 720);
		_char[3].setPosition(0, 0);
		_char[3].changeFloorHeight(0);

		_char[4] = new EventImage();
		_char[4].setImage("assets/images/CutsceneAssets/kitchen_daughter.png", 1280, 720);
		_char[4].setPosition(0, 0);
		_char[4].changeFloorHeight(0);		
		
		_char[5] = new EventImage();
		_char[5].setImage("assets/images/CutsceneAssets/kitchen_table.png", 1280, 720);
		_char[5].setPosition(0, 0);
		_char[5].changeFloorHeight(0);		
		
		_char[6] = new EventImage();
		_char[6].setImage("assets/images/CutsceneAssets/kitchen_dad.png", 1280, 720);
